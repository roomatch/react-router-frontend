...
export default function Signup() {
    ...
    return (
        <Toast.Provider swipeDirection="right">
            <Label.Root htmlFor="dropzone-file" className={`flex flex-col items-center justify-center w-2/4 h-64 border-2 ${filesMutation.isError ? 'border-red-500' : null} ${filesMutation.isSuccess ? 'border-green-600' : null} transition-colors border-gray-300 border-dashed rounded-xl cursor-pointer hover:text-white hover:bg-cerulean dark:hover:bg-prussian-blue`}>
                <svg className={`w-8 h-8 mb-4 ${filesMutation.isError ? 'text-red-500' : null} ${filesMutation.isSuccess ? 'text-green-600' : null} transition-colors text-gray-300`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                ...
                <Flex display="flex" direction="row" justify="between" align="center">
                    <Toast.Title asChild>
                        <Flex display="flex" align="center" gap="1">
                            ...
                            <Text as="p" size="2" className="dark:text-mirrage">Cargando imágenes...</Text>
                        </Flex>
                    </Toast.Title>
                    <Toast.Action
                        asChild
                ...
                <Flex display="flex" direction="row" justify="between" align="center">
                    <Toast.Title asChild>
                        <Flex display="flex" align="center" gap="1">
                            ...
                            <Text as="p" size="2" className="dark:text-mirrage">{`${state.images.length} ${state.images.length == 1 ? 'imágen cargada' : 'imágenes cargadas'} exitosamente.`}</Text>
                        </Flex>
                    </Toast.Title>
                    <Toast.Action
                        asChild
                ...
                <Flex display="flex" direction="row" justify="between" align="center">
                    <Toast.Title asChild>
                        <Flex display="flex" align="center" gap="1">
                            ...
                            <Text as="p" size="2" className="dark:text-mirrage">Hubo un problema con la carga de tus imágenes, contactanos para ayudarte.</Text>
                        </Flex>
                    </Toast.Title>
                    <Toast.Action
                        asChild
