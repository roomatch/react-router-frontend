...
export default function Hero() {
  return (
    <Flex direction="column" align="center" justify="center" gap="3" className="h-[90dvh] mt-6 mx-6 p-6 rounded-lg bg-gradient-to-b from-transparent to-prussian-blue border-electric-indigo border-b-2">
      ...
      <video className="rounded-lg" autoPlay loop muted playsInline><source src={heroVideo} type="video/mp4" /></video>
    </Flex>
  )
}
